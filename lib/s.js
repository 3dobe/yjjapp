...
module.exports = function(app, config) {
    ...
    app.post('/do/s/open', function(req, res) {
        ...
        var lname = req.body['lname'],
            ...
            spkid = speakerList.nextId ++,
            speaker = new Speaker(spkid, spkname),
            lectid = lectureList.nextId ++;
    ...
    /* 添加投票 */
    app.all('/do/s/addvote',function(req, res){
        var spkid = req.session['speakerId'],
            ...
            voteId = voteList.nextId ++,
            vote = new Vote(voteId, content, options);
        voteList.insert(vote);
        //绑定vote和lecture
        lect.addVote(vote);
        res.send({
            ok : 1,
